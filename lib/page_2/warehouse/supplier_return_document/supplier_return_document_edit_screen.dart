...
class SupplierReturnDocumentEditScreen extends StatefulWidget {
  ...
  @override
  _SupplierReturnDocumentEditScreenState createState() =>
      _SupplierReturnDocumentEditScreenState();
}

class _SupplierReturnDocumentEditScreenState
    extends State<SupplierReturnDocumentEditScreen>
  ...
  int? _selectedSupplierCurrencyId;
  String? _selectedSupplierCurrencyName;
  ...
  void _initializeFormData() {
    ...
    _selectedSupplierCurrencyId = widget.document.model?.currencyId;
    _selectedSupplierCurrencyName = widget.document.currency?.name;
    ...
    if (widget.document.documentGoods != null) {
      for (var good in widget.document.documentGoods!) {
        ...
        /// USE 1 for amount DO NOT CALCULATE FROM UNIT
  ...
  /// 🔍 Добавляет товар через штрих-код с quantity=1 (возврат поставщику - редактирование)
  ...
  /// 🔍 Обработчик сканирования штрих-кода (возврат поставщику)
      ...
      child: Column(
        ...
        children: [
          ...
          SupplierWidget(
            ...
            onChangedSupplier: (Supplier? supplier) => setState(() {
              _selectedSupplierCurrencyId =
                  supplier?.currency?.id ?? supplier?.currencyId;
              _selectedSupplierCurrencyName = supplier?.currency?.name;
              _exchangeRateErrorText = null;
              if (!_isExchangeRateRequired) {
                _exchangeRateController.clear();
              }
    ...
    return AppBar(
      ...
      title: _isSearching
        ...
        children: [
          Expanded(
            child: Text(
              '${localizations.translate('edit_supplier_return_document') ?? 'Редактировать возврат'} №${widget.document.docNumber}',
              maxLines: 1,
