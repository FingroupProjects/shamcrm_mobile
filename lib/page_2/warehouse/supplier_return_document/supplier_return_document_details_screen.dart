...
class SupplierReturnDocumentDetailsScreen extends StatefulWidget {
  ...
  @override
  _SupplierReturnDocumentDetailsScreenState createState() =>
      _SupplierReturnDocumentDetailsScreenState();
}

class _SupplierReturnDocumentDetailsScreenState
    extends State<SupplierReturnDocumentDetailsScreen> {
  ...
  Future<void> _fetchDocumentDetails() async {
    ...
    try {
      final document =
          await _apiService.getSupplierReturnDocumentById(widget.documentId);
      setState(() {
  ...
  Future<void> _approveDocument() async {
    ...
    try {
      ...
      final localizations = AppLocalizations.of(context)!;
      _showSnackBar(
        localizations.translate('document_approved_successfully') ??
            'Документ проведен',
        true,
      );
    } catch (e) {
  ...
  Future<void> _unApproveDocument() async {
    ...
    try {
      await _apiService.unApproveSupplierReturnDocument(widget.documentId);
      setState(() {
  ...
  Future<void> _restoreDocument() async {
    ...
    try {
      ...
      final localizations = AppLocalizations.of(context)!;
      _showSnackBar(
        localizations.translate('document_restored_successfully') ??
