    ...
    if (mounted && newItem != null) {
      setState(() {
        ...
        if (existingIndex == -1) {
          ...
          _quantityControllers[variantId] = TextEditingController(text: '1'); // ✅ НОВОЕ: Устанавливаем 1 по умолчанию для UX
          ...
          _items.last['quantity'] = 1; // ✅ НОВОЕ: Синхронизируем с контроллером
