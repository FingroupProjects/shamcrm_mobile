...
class EditClientReturnDocumentScreen extends StatefulWidget {
  ...
  @override
  _EditClientReturnDocumentScreenState createState() =>
      _EditClientReturnDocumentScreenState();
}

class _EditClientReturnDocumentScreenState
    extends State<EditClientReturnDocumentScreen>
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      ...
      if (_tabController.index == 1) {
        if (_selectedLead == null || _selectedStorage == null) {
  ...
  /// 🔍 Добавляет товар через штрих-код с quantity=1 (возврат от клиента - редактирование)
  ...
  /// 🔍 Обработчик сканирования штрих-кода (возврат от клиента)
    ...
    return AppBar(
      ...
      title: _isSearching
        ...
        children: [
          Expanded(
            child: Text(
              '${localizations?.translate('edit_client_return') ?? 'Редактировать'} №${widget.document.docNumber}',
              maxLines: 1,
