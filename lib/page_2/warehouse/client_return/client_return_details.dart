...
class ClientReturnDocumentDetailsScreen extends StatefulWidget {
  ...
  @override
  _ClientReturnDocumentDetailsScreenState createState() =>
      _ClientReturnDocumentDetailsScreenState();
}

class _ClientReturnDocumentDetailsScreenState
    extends State<ClientReturnDocumentDetailsScreen> {
  ...
  Future<void> _fetchDocumentDetails() async {
    ...
    try {
      final document = await _apiService.getClientReturnById(widget.documentId);
      setState(() {
  ...
  Future<void> _approveDocument() async {
    ...
    try {
      await _apiService.approveClientReturnDocument(widget.documentId);
      setState(() {
  ...
  Future<void> _unApproveDocument() async {
    ...
    try {
      await _apiService.unApproveClientReturnDocument(widget.documentId);
      setState(() {
