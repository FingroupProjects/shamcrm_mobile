...
class EditWarehouseScreen extends StatefulWidget {
  ...
  final List<int> userIds; // Existing user IDs associated with the warehouse
...
class _EditWarehouseScreenState extends State<EditWarehouseScreen> {
  ...
  void initState() {
    super.initState();
    // Pre-populate form fields with warehouse data
    nameController.text = widget.warehouse.name ?? '';
    // Initialize selected user IDs as strings for WarehouseMultiUser
                            ...
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                context.read<WareHouseBloc>().add(
                                    UpdateWareHouse(updatedWarehouse, ids,
                                        widget.warehouse.id));
                              }
                            },
                          );
