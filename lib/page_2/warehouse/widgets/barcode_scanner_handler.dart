...
///
/// [items] — текущий список товаров документа
/// [barcode] — отсканированный штрих-код
/// [docType] — тип документа
/// [onItemAdded] — callback при добавлении нового товара
/// [onQuantityIncreased] — callback при увеличении количества (variantId, newQty)
...
/// Показывает красивый SnackBar при успешном сканировании (товар найден)
void showBarcodeSuccessSnackBar({
  ...
  final message = isNewItem
      ? '${localizations?.translate('barcode_item_added') ?? 'Товар добавлен'}: $itemName'
      : '${localizations?.translate('barcode_quantity_increased') ?? 'Количество увеличено'}: $itemName × ${quantity.toStringAsFixed(quantity == quantity.roundToDouble() ? 0 : 2)}';
...
/// Показывает красивый SnackBar когда товар не найден по штрих-коду
...
/// Виджет-кнопка для AppBar — иконка поиска и иконка сканера штрих-кода
              ...
              children: [
                if (onSearchPressed != null)
                  IconButton(
                    ...
                    tooltip: 'Поиск по штрих-коду или названию',
