...
class SupplierOpeningDetailsScreen extends StatefulWidget {
  final SupplierOpening opening;
  final VoidCallback? onOpeningUpdated;

  const SupplierOpeningDetailsScreen({
  ...
  @override
  _SupplierOpeningDetailsScreenState createState() =>
      _SupplierOpeningDetailsScreenState();
}

class _SupplierOpeningDetailsScreenState
    extends State<SupplierOpeningDetailsScreen> {
  late SupplierOpening currentOpening;
