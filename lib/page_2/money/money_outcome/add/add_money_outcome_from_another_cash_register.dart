...
class AddMoneyOutcomeAnotherCashRegister extends StatefulWidget {
  ...
  @override
  State<AddMoneyOutcomeAnotherCashRegister> createState() =>
      _AddMoneyOutcomeAnotherCashRegisterState();
}

class _AddMoneyOutcomeAnotherCashRegisterState
    extends State<AddMoneyOutcomeAnotherCashRegister> {
  ...
  void _createDocument({bool approve = false}) {
    ...
    context.read<MoneyOutcomeBloc>().add(CreateMoneyOutcome(
          date: apiDate,
          amount: amount,
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              _buildActionButtons(localizations, colors),
            ],
          ),
        ),
      ),
  ...
  Widget _buildActionButtons(
      AppLocalizations localizations, AppThemeColors colors) {
    return Container(
        ...
        children: [
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                borderRadius: BorderRadius.circular(12),
                onTap: _isLoading ? null : () => _createDocument(approve: true),
                child: Row(
          ...
          Row(
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed:
                      _isLoading ? null : () => _createDocument(approve: false),
                  style: ElevatedButton.styleFrom(
