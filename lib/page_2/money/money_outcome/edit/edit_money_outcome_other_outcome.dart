...
class EditMoneyOutcomeOtherOutcome extends StatefulWidget {
  ...
  const EditMoneyOutcomeOtherOutcome({
    super.key,
    required this.document,
  });

  @override
  _EditMoneyOutcomeOtherOutcomeState createState() =>
      _EditMoneyOutcomeOtherOutcomeState();
}

class _EditMoneyOutcomeOtherOutcomeState
    extends State<EditMoneyOutcomeOtherOutcome> {
  ...
  void _createDocument() async {
    ...
    final dataChanged = !areDatesEqual(widget.document.date ?? '', isoDate) ||
        ...
        widget.document.article?.id.toString() !=
            selectedOutcomeCategory?.id.toString();
