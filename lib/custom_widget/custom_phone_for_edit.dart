...
class _CustomPhoneNumberInputState extends State<CustomPhoneNumberInput> {
  ...
  void initState() {
    ...
    selectedCountry = countries.firstWhere(
      ...
      orElse: () {
        //print('Страна с кодом ${widget.selectedDialCode} не найдена, выбираем TJ');
        return countries.firstWhere((country) => country.name == "TJ");
      },
    );
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedErrorBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: const BorderSide(
                color: Color(0xFFE53935), // Красный цвет для границы ошибки при фокусе
                width: 1.0,
              ),
            ),
            filled: true,
