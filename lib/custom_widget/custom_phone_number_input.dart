...
class _CustomPhoneNumberInputState extends State<CustomPhoneNumberInput> {
  ...
  TextInputFormatter _phoneNumberPasteFormatter() {
    return TextInputFormatter.withFunction((oldValue, newValue) {
      print('Formatter: Входной текст: ${newValue.text}');
      ...
      if (matchedDialCode != null && matchedCountry != null && matchedCountry.name.isNotEmpty) {
        ...
        if (RegExp(r'^\d*$').hasMatch(phoneNumber)) {
          ...
          int maxLength = phoneNumberLengths[matchedDialCode] ?? 0;
          print('Formatter: Максимальная длина номера для $matchedDialCode: $maxLength');
      ...
      // Если код страны не найден, возвращаем исходный текст
      print('Formatter: Возвращаем исходный текст: ${newValue.text}');
      return newValue;
    });
  }
