              ...
              child: Row(
                children: [
                  Transform.scale(
                    scale: 0.9,
                    child: Switch(
                      value: _isLeadSelected,
                      onChanged: (value) {
                        setState(() {
                          _isLeadSelected = value;
                        });
                      },
                  ...
                  Expanded(
                    child: Text(
                      _isLeadSelected
                          ? AppLocalizations.of(context)!.translate('filter_by_client') ?? 'Фильтр по клиенту'
                          : AppLocalizations.of(context)!.translate('filter_by_supplier') ?? 'Фильтр по поставщику',
                      style: const TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w500,
                        fontFamily: 'Gilroy',
