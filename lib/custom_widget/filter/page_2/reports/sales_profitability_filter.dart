...
class SalesProfitabilityFilterScreen extends StatefulWidget {
  ...
  const SalesProfitabilityFilterScreen({
    Key? key,
  ...
  @override
  _SalesProfitabilityFilterScreenState createState() => _SalesProfitabilityFilterScreenState();
}
...
class _SalesProfitabilityFilterScreenState extends State<SalesProfitabilityFilterScreen> {
  ...
  Future<void> _loadFilterState() async {
    ...
    setState(() {
      final fromDateMillis = prefs.getInt('sales_profitability_from_date');
      final toDateMillis = prefs.getInt('sales_profitability_to_date');
      ...
      _amountFromController.text = prefs.getString('sales_profitability_amount_from') ?? widget.initialAmountFrom ?? '';
      _amountToController.text = prefs.getString('sales_profitability_amount_to') ?? widget.initialAmountTo ?? '';
    });
  }
  ...
  Future<void> _saveFilterState() async {
    final prefs = await SharedPreferences.getInstance();
    if (_fromDate != null) {
      await prefs.setInt('sales_profitability_from_date', _fromDate!.millisecondsSinceEpoch);
    } else {
      await prefs.remove('sales_profitability_from_date');
    }
    if (_toDate != null) {
      await prefs.setInt('sales_profitability_to_date', _toDate!.millisecondsSinceEpoch);
    } else {
      await prefs.remove('sales_profitability_to_date');
    }
    await prefs.setString('sales_profitability_amount_from', _amountFromController.text);
    await prefs.setString('sales_profitability_amount_to', _amountToController.text);
  }
