...
class CreditorsFilterScreen extends StatefulWidget {
  ...
  @override
  State<CreditorsFilterScreen> createState() => _CreditorsFilterScreenState();
}
...
class _CreditorsFilterScreenState extends State<CreditorsFilterScreen> {
  ...
  Future<void> _loadFilterState() async {
    ...
    setState(() {
      ...
      _amountFromController.text = prefs.getString('creditors_amount_from') ??
          widget.initialAmountFrom ??
          '';
      _amountToController.text = prefs.getString('creditors_amount_to') ??
  ...
  Future<void> _saveFilterState() async {
    ...
    if (_fromDate != null) {
      await prefs.setInt(
          'creditors_from_date', _fromDate!.millisecondsSinceEpoch);
    } else {
  ...
  void _applyFilters() async {
    ...
    if (!_isAnyFilterSelected()) {
      ...
      debugPrint('CreditorFilter.filters: $filters');
