...
class _GoodsFilterScreenState extends State<GoodsFilterScreen> {
  ...
  void initState() {
    super.initState();
    // Предполагается, что subCategories загружаются через ApiService
    // Например, через context.read<GoodsBloc>().add(FetchSubCategories());
  }
          ...
          TextButton(
            onPressed: () {
              ...
              if (selectedCategory != null) {
                filters['subcategory_id'] = selectedCategory!.id;
              }
