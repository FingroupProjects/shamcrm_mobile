...
class _TaskCopyScreenState extends State<TaskCopyScreen> {
  ...
  Future<void> _checkPermissions() async {
    try {
      ...
      //print('TaskCopyScreen: Permissions - task.update: $_canUpdateTask, task.createForMySelf: $_hasTaskCreateForMySelfPermission, userID: $_currentUserId');
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: TaskSectionAppBar(
        title: AppLocalizations.of(context)!.translate('copy_task'),
