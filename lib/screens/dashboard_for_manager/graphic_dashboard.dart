...
class GraphicsDashboardManager extends StatefulWidget {
  const GraphicsDashboardManager({Key? key}) : super(key: key);

  @override
  _GraphicsDashboardStateManager createState() => _GraphicsDashboardStateManager();
}

class _GraphicsDashboardStateManager extends State<GraphicsDashboardManager> {
  int currentPage = 0;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DashboardChartBlocManager, DashboardChartStateManager>(
      builder: (context, state) {
        ...
        if (state is DashboardChartErrorManager) {
        ...
        if (state is DashboardChartLoadedManager && state.chartData.isNotEmpty) {
  ...
  List<List<ChartDataManager>> _paginateData(List<ChartDataManager> chartData) {
    List<List<ChartDataManager>> paginatedData = [];
  ...
  Widget _buildPagination(List<List<ChartDataManager>> paginatedData) {
