...
class ProcessSpeedGaugeManager extends StatefulWidget {
  const ProcessSpeedGaugeManager({Key? key}) : super(key: key);

  @override
  State<ProcessSpeedGaugeManager> createState() => _ProcessSpeedGaugeStateManager();
}

class _ProcessSpeedGaugeStateManager extends State<ProcessSpeedGaugeManager>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ProcessSpeedBlocManager, ProcessSpeedStateManager>(
      listener: (context, state) {
        ...
        } else if (state is ProcessSpeedErrorManager) {
      ...
      builder: (context, state) {
        ...
        } else if (state is ProcessSpeedLoadingManager) {}
