...
class LeadConversionChartManager extends StatefulWidget {
  const LeadConversionChartManager({Key? key}) : super(key: key);

  @override
  State<LeadConversionChartManager> createState() =>
      _LeadConversionChartStateManager();
}
class _LeadConversionChartStateManager
    extends State<LeadConversionChartManager> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DashboardConversionBlocManager,
        DashboardConversionStateManager>(
      builder: (context, state) {
        if (state is DashboardConversionErrorManager) {
          return Center(
            child: Text(
              '${state.message}',
