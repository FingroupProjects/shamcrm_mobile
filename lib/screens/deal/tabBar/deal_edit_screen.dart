      ...
      body: BlocListener<DealBloc, DealState>(
        listener: (context, state) {
          if (state is DealError) {
            ...
            // Navigator.pop(context, {'dealId': widget.dealId, 'updatedDeal': updatedDeal});
            //  Navigator.pop(context, widget.dealId); // Передаем только ID сделки
...
//                             context.read<DealBloc>().add(dealData);
//                           }
//                         },
//                       ),
//                     ),
