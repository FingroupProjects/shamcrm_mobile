...
class _SipScreenState extends State<SipScreen>
  ...
  Timer? _unifiedSearchDebounce;
  Timer? _contactsLeadSearchDebounce;
  Timer? _contactsIndexOverlayTimer;
  Timer? _journalDateRailOverlayTimer;
  int _unifiedSearchRequestId = 0;
  int _contactsLeadRequestId = 0;
  int _dialSuggestionRequestId = 0;
  _SipSearchSource _searchSource = _SipSearchSource.calls;
  List<SipCallLogEntry> _unifiedCallResults = const [];
  bool _isUnifiedCallSearchLoading = false;
  bool _isUnifiedCallSearchLoadingMore = false;
  int _unifiedCallSearchPage = 0;
  bool _unifiedCallSearchHasMore = true;
  bool _isUnifiedLeadSearchLoadingMore = false;
  int _unifiedLeadSearchPage = 0;
  bool _unifiedLeadSearchHasMore = true;
