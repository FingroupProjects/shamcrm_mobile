...
Widget build(BuildContext context) {
  ...
  listener: (context, state) {
    if (state is LeadError) {
      ...
      // Pop the screen after a successful save
      Navigator.pop(context);
    }
  },
      child: Form(
                ...
                children: [
                  ...
                  CustomPhoneNumberInput(
                    ...
                    onInputChanged: (String number) {
                      setState(() {
                        selectedDialCode = number; // Сохраняем код страны
                      });
                    },
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                   ...
                   child: CustomButton(
                     ...
                     onPressed: () {
                       if (_formKey.currentState!.validate()) {
                         ...
                         final String phone = selectedDialCode; // Объединяем код страны и номер
                         ...
                         final String? whatsapp = whatsappController.text.isEmpty || selectedDialCode.isEmpty ? null : selectedDialCode;
