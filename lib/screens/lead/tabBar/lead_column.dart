                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: const TextStyle(color: Color(0xff1E2E52), fontSize: 20, fontFamily: "Gilroy", fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(height: 8),
                          const Divider(color: Color(0xff1E2E52)),
                          ListTile(
                            title: Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: const TextStyle(color: Color(0xff1E2E52), fontSize: 16, fontFamily: "Gilroy", fontWeight: FontWeight.w500),
                                ),
                                const Icon(Icons.add, color: Color(0xff1E2E52), size: 25),
                              ],
                            ),
                            onTap: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (_) => LeadAddScreen(statusId: widget.statusId)),
                              ).then((_) => context.read<LeadBloc>().add(FetchLeads(widget.statusId, ignoreCache: true)));
                            },
                          ),
                          ListTile(
                            title: Row(
                              ...
                              children: [
                                ...
                                const Icon(Icons.contacts, color: Color(0xff1E2E52), size: 25),
                              ],
                            ),
                            onTap: () {
                              Navigator.pop(context);
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (_) => ContactsScreen(statusId: widget.statusId)),
                              ).then((_) => context.read<LeadBloc>().add(FetchLeads(widget.statusId, ignoreCache: true)));
                            },
                          ),
