    ...
    private fun updateAppWidget(
        ...
        try {
            ...
            val allButtons = listOf(
                AccountingButton("client_sale", android.R.drawable.ic_menu_send, "expense_document.read"),
                AccountingButton("client_return", android.R.drawable.ic_menu_revert, "client_return_document.read"),
                AccountingButton("income_goods", android.R.drawable.ic_menu_add, "income_document.read"),
                AccountingButton("transfer", android.R.drawable.ic_menu_sort_alphabetically, "movement_document.read"),
                AccountingButton("write_off", android.R.drawable.ic_menu_delete, "write_off_document.read"),
                AccountingButton("supplier_return", android.R.drawable.ic_menu_revert, "supplier_return_document.read"),
                AccountingButton("money_income", android.R.drawable.ic_menu_add, "checking_account_pko.read"), // Using add icon
                AccountingButton("money_outcome", android.R.drawable.ic_menu_delete, "checking_account_rko.read") // Using delete icon
            )
