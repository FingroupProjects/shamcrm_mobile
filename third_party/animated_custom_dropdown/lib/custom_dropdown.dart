...
class CustomDropdownPaginatedResponse<T> {
  final List<T> items;
  final bool hasMore;

  const CustomDropdownPaginatedResponse({
    required this.items,
...
class CustomDropdown<T> extends StatefulWidget {
  ...
  /// The asynchronous computation from which the paginated items list returns.
  ...
  /// Widget to display while the next page is loading.
  ...
  /// Force the overlay to open above the field instead of below.
  ...
  const CustomDropdown.searchRequestPaginated({
    super.key,
  ...
  const CustomDropdown.multiSelectSearchRequestPaginated({
    super.key,
    required this.paginatedRequest,
    required this.onListChanged,
    this.multiSelectController,
